...
let CreateComponent = class CreateComponent extends _web3Enabled__WEBPACK_IMPORTED_MODULE_3__["Web3Enabled"] {
    constructor(web3, route) {
        super(web3);
        this.route = route;
    ...
    ngOnInit() {
        this.connect(() => {
            ...
            const abi = __webpack_require__(/*! ../../assets/abis/Fantastic12Factory.json */ "./src/assets/abis/Fantastic12Factory.json");
    ...
    connect(onConnected, onError) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.assistInstance === null) {
                ...
                const wallets = yield bnc_onboard__WEBPACK_IMPORTED_MODULE_2__["modules"].select([
                    { name: 'coinbase' },
                    { name: 'trust' },
                    { name: 'metamask' },
                    { name: 'dapper' },
            ...
            let selectedWallet = yield this.assistInstance.walletSelect();
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!isNaN(gasLimit)) {
                return func.send({
                    ...
                    _onTxHash(hash);
                    let listener = setInterval(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                        let receipt = yield this.web3.eth.getTransaction(hash);
